	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(files, url, onLoadEnd) {
				...
				var imageFormData, i, response, multiple, _imagePreviewUrls2, responseUrls, err, _err;
						...
						switch (_context.prev = _context.next) {
							...
							case 11:
								...
								if (response instanceof Array || typeof response === "string") {
									...
									if (multiple === false) {
										_imagePreviewUrls2 = response instanceof Array ? [response[0].url] : [response.url];
									} else {
										responseUrls = response.map(function (element) {
											return element.url;
										});

										_imagePreviewUrls2 = [].concat((0, _toConsumableArray3.default)(this.state.imagePreviewUrls), (0, _toConsumableArray3.default)(responseUrls));
									}

									console.log("gyutae - imagePreviewUrls", _imagePreviewUrls2);
