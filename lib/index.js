						...
						switch (_context.prev = _context.next) {
							...
							case 11:
								...
								if (response instanceof Array || typeof response === "string") {
									...
									if (multiple === false) {
										_imagePreviewUrls2 = response instanceof Array ? response.url : [response.url];
									} else {
										_imagePreviewUrls2 = [].concat((0, _toConsumableArray3.default)(this.state.imagePreviewUrls), [response.url]);
									}
