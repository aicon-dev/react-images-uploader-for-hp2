...
var _reactImageFileResizer = require("react-image-file-resizer");

var _reactImageFileResizer2 = _interopRequireDefault(_reactImageFileResizer);
	...
	(0, _createClass3.default)(ImagesUploader, [{
		...
		value: function () {
			var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(files, url, onLoadEnd) {
				...
				var imageFormData, i, response, multiple, err, _err;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 6:
								...
								if (!(response && response.status && response.status === 200 || response && response.status && response.status === 201)) {
									_context.next = 15;
									break;
								}
							...
							case 10:
								...
								if (response instanceof Array || typeof response === "string") {
									(function () {
										var imagePreviewUrls = [];
										if (multiple === false) {
											imagePreviewUrls = response instanceof Array ? [response[0].thumbnailUrl || response[0].url] : [response.thumbnailUrl || response[0].url];
										} else {
											var responseUrls = response.map(function (element) {
												return element.thumbnailUrl || element.url;
											});
											imagePreviewUrls = [].concat((0, _toConsumableArray3.default)(_this3.state.imagePreviewUrls), (0, _toConsumableArray3.default)(responseUrls));
										}
		...
		key: "resizeFile",
		value: function () {
			var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(file, maxWidth, maxHeight) {
				...
				return _regenerator2.default.wrap(function _callee2$(_context2) {
					while (1) {
						switch (_context2.prev = _context2.next) {
							case 0:
								compressFormat = file.type.indexOf('png') > -1 ? 'PNG' : 'JPEG';
								return _context2.abrupt("return", new Promise(function (resolve) {
									_reactImageFileResizer2.default.imageFileResizer(file, maxWidth, maxHeight, compressFormat, quality, 0, function (file) {
										resolve(file);
									}, "file");
								}));
			...
			function resizeFile(_x4, _x5, _x6, _x7) {
		...
		value: function () {
			var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(e) {
				...
				var filesList, _props2, onLoadStart, onLoadEnd, url, optimisticPreviews, multiple, resizeOption, quality, maxWidth, maxHeight, err, i, file, reader, _err2, isPngOrJpeg;
					...
					while (1) {
						switch (_context3.prev = _context3.next) {
							case 0:
								...
								filesList = [].concat((0, _toConsumableArray3.default)(e.target.files));
								_props2 = this.props, onLoadStart = _props2.onLoadStart, onLoadEnd = _props2.onLoadEnd, url = _props2.url, optimisticPreviews = _props2.optimisticPreviews, multiple = _props2.multiple, resizeOption = _props2.resizeOption;
								quality = resizeOption.quality, maxWidth = resizeOption.maxWidth, maxHeight = resizeOption.maxHeight;
							...
							case 22:
								isPngOrJpeg = file.type === 'image/jpeg' ? 'JPEG' : file.type === 'image/png' ? 'PNG' : null;
								...
								_context3.prev = 24;
								_context3.next = 27;
								return this.resizeFile(file, maxWidth, maxHeight, quality);

							case 27:
								filesList[i] = _context3.sent;
								_context3.next = 33;
								break;
							...
							case 30:
								...
								console.log('IMAGE RESIZE FAIL', _context3.t0);
			...
			function handleImageChange(_x9) {
		...
		value: function buildButtonContent() {
			...
			if (multiple !== false) {
				return _react2.default.createElement(
					"div",
					null,
					(this.state.loadState === "" || this.state.loadState === "success") && _react2.default.createElement(
						"div",
						null,
						_react2.default.createElement(
							"p",
					...
					this.state.loadState === "loading" && _react2.default.createElement(
						"div",
						{ className: "loader" },
						"\uC62C\uB9AC\uB294 \uC911..."
					),
					this.state.loadState === "error" && _react2.default.createElement(
						"p",
			...
			if ((!imagePreviewUrls || imagePreviewUrls.length < 1) && (!optimisticPreviews || optimisticPreviews.length < 1)) {
				return _react2.default.createElement(
					...
					this.state.loadState === "loading" && _react2.default.createElement(
						"div",
						{ style: { background: "white" }, className: "loader" },
						"Loading..."
					),
					this.state.loadState === "error" && _react2.default.createElement(
						"p",
...
ImagesUploader.propTypes = {
	...
	resizeOption: _propTypes2.default.object,
